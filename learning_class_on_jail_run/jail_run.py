#мне тут предложили потренироваться создавать классы и объекты
#задача конечно удобнее решается через функции, но я решил потренироваться
#так что тут всё очень и очень страшно
#возможно когда-нибудь я сделаю эту задачку через функции как белый человек
#описание задачи есть здесь https://habr.com/post/250817/
#на будущее себе будущему - разобраться с комбинаторикой!
